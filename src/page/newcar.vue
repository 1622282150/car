  ...
  z-index: 1000;width:100%;background:#ffffff;height:1.7rem;;"
    >
      <div class="head">
        ...
        <input type="text" class="inputbox" v-model="value" @click="search" placeholder="搜索更多好车">
        <i
          @click="fuwu"
          class="iconfont"
          style="font-szie:18px;margin-top:0.5rem;margin-left:0.6rem"
        >&#xe605;</i>
      </div>
    </div>
    ...
    <div class="tabbarr" ref="ull">
      <div class="tabbarrul" @click="toptu1">
        ...
        <div class="sonone">超低首付</div>
        <div class="sontwo">首付低至0元</div>
      </div>
      <div class="tabbarrultwo" @click="toptu2">
         <div style="position:absolute;left:0;width:1px;height:4.5rem;background:#e6e6e6;"></div>
        <div class="sonone">最低月供</div>
        <div class="sontwo">月供低至1300</div>
      </div>
      <div class="tabbarrulthree" @click="toptu3">
         <div style="position:absolute;left:0;width:100%;height:1px;background:#e6e6e6;"></div>
        <div class="sonone">进口车</div>
        <div class="sontwo">进口车卖得好</div>
      </div>
      <div class="tabbarrulfour" @click="toptu4">
         <div style="position:absolute;left:0;width:100%;height:1px;background:#e6e6e6;"></div>
        <div style="position:absolute;left:0;width:1px;height:4.5rem;background:#e6e6e6;"></div>
        <div class="sonone">热门SUV</div>
        <div class="sontwo">高品质够实惠</div>
      </div>
    </div>
  ...
  methods: {
    ...
    toptu1() {
      request
        ...
        .then(res => {
          this.newcarlist = res.data.Data.list;
        })
        .catch(err => {});
    },
    toptu2() {
...
.tabbarrul {
  ...
  width: 50%;
  height: 4.5rem;
  background: url("../assets/images/tucengone.png") no-repeat;
...
.tabbarrultwo {
  ...
  width: 50%;
  height: 4.5rem;
  background: url("../assets/images/tucengtwo.png") no-repeat;
   background-size: 100% 100%;
}
.tabbarrulthree {
  position: relative;
  ...
  width: 50%;
  height: 4.5rem;
  background: url("../assets/images/tucengthree.png") no-repeat;
   background-size: 100% 100%;
}
.tabbarrulfour {
  position: relative;
  ...
  width: 50%;
  height: 4.5rem;
  background: url("../assets/images/tucengfour.png") no-repeat;
   background-size: 100% 100%;
}
